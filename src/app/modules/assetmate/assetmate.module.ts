...
@NgModule({
  ...
  entryComponents: [AssetCodeComponent, ConfirmDialogComponent, AssetAddComponent, AddAssetDocumentComponent, AssetAssignNewUsersComponent, AddAssignUserComponent]
})
